...
{
    private TageValueData _value; // Value type data that can be stored inside TagValue
    ...
    public static TagValue CreateInt(int value)
    {
        ...
        unsafe
        {
            *(int*)(&tagValue._value) = value;
        }
        tagValue.Type = TagType.Int;
        return tagValue;
    }
    ...
    {
        TagValue tagValue = new();
        tagValue._object = value;
        tagValue.Type = TagType.String;
        return tagValue;
    }
    ...
    {
        if (Type == TagType.Int)
            return Unsafe.As<TageValueData, int>(ref _value);
        else
